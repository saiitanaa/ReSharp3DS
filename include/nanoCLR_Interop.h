...
#define NANOCLR_LEAVE()                                                                                                \
    {                                                                                                                  \
        if (FAILED(hr))                                                                                                \
            NANOCLR_DEBUG_PROCESS_EXCEPTION(hr, __func__, __FILE__, __LINE__);                                         \
        goto nanoCLR_Cleanup;                                                                                          \
    }
#define NANOCLR_RETURN() return hr
...
#define NANOCLR_CHECK_HRESULT(expr)                                                                                    \
    {                                                                                                                  \
        if (FAILED(hr = (expr)))                                                                                       \
            NANOCLR_LEAVE();                                                                                           \
    }
#define NANOCLR_EXIT_ON_SUCCESS(expr)                                                                                  \
    {                                                                                                                  \
        if (SUCCEEDED(hr = (expr)))                                                                                    \
            NANOCLR_LEAVE();                                                                                           \
    }
#define NANOCLR_SET_AND_LEAVE(expr)                                                                                    \
    {                                                                                                                  \
        hr = (expr);                                                                                                   \
        NANOCLR_LEAVE();                                                                                               \
    }
#if defined(_MSC_VER)
#define NANOCLR_MSG_SET_AND_LEAVE(expr, msg)                                                                           \
    {                                                                                                                  \
        wprintf(msg);                                                                                                  \
        hr = (expr);                                                                                                   \
        NANOCLR_LEAVE();                                                                                               \
...
#define NANOCLR_CHARMSG_SET_AND_LEAVE(expr, msg, ...)                                                                  \
    {                                                                                                                  \
...
#endif
#define NANOCLR_CLEANUP()                                                                                              \
    hr = S_OK;                                                                                                         \
    nanoCLR_Cleanup:
#define NANOCLR_CLEANUP_END() NANOCLR_RETURN()
#define NANOCLR_NOCLEANUP()                                                                                            \
    NANOCLR_CLEANUP();                                                                                                 \
    NANOCLR_CLEANUP_END()
#define NANOCLR_NOCLEANUP_NOLABEL()                                                                                    \
    hr = S_OK;                                                                                                         \
    NANOCLR_RETURN()
#define FAULT_ON_NULL(ptr)                                                                                             \
    if (!(ptr))                                                                                                        \
    NANOCLR_SET_AND_LEAVE(CLR_E_NULL_REFERENCE)
#define FAULT_ON_NULL_ARG(ptr)                                                                                         \
    if (!(ptr))                                                                                                        \
...

{
    ...
    friend HRESULT Interop_Marshal_bool_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<unsigned char> &typedArray);
    ...
    friend HRESULT Interop_Marshal_UINT16_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<unsigned short int> &typedArray);
    friend HRESULT Interop_Marshal_UINT32_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<unsigned int> &typedArray);
    friend HRESULT Interop_Marshal_UINT64_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<unsigned __int64> &typedArray);
    friend HRESULT Interop_Marshal_CHAR_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<char> &typedArray);
    friend HRESULT Interop_Marshal_INT8_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<signed char> &typedArray);
    friend HRESULT Interop_Marshal_INT16_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<signed short int> &typedArray);
    friend HRESULT Interop_Marshal_INT32_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<signed int> &typedArray);
    friend HRESULT Interop_Marshal_INT64_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<signed __int64> &typedArray);

#if !defined(NANOCLR_EMULATED_FLOATINGPOINT)
    friend HRESULT Interop_Marshal_float_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<float> &typedArray);
    friend HRESULT Interop_Marshal_double_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
        CLR_RT_TypedArray<double> &typedArray);
#else
    friend HRESULT Interop_Marshal_float_ARRAY(
        const CLR_RT_StackFrame &stackFrame,
        unsigned int paramIndex,
  ...
  public:
    ...
    void SetValue(unsigned int i, T &val)
    {
        m_pData[i] = val;
    }
...
HRESULT Interop_Marshal_bool_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_UINT8 &typedArray);
HRESULT Interop_Marshal_UINT8_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_UINT8 &typedArray);
HRESULT Interop_Marshal_UINT16_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_UINT16 &typedArray);
HRESULT Interop_Marshal_UINT32_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_UINT32 &typedArray);
HRESULT Interop_Marshal_UINT64_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_UINT64 &typedArray);
HRESULT Interop_Marshal_CHAR_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_CHAR &typedArray);
HRESULT Interop_Marshal_INT8_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_INT8 &typedArray);
HRESULT Interop_Marshal_INT16_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_INT16 &typedArray);
HRESULT Interop_Marshal_INT32_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_INT32 &typedArray);
HRESULT Interop_Marshal_INT64_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_INT64 &typedArray);
HRESULT Interop_Marshal_float_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_float &typedArray);
HRESULT Interop_Marshal_double_ARRAY(
    const CLR_RT_StackFrame &stackFrame,
    unsigned int paramIndex,
    CLR_RT_TypedArray_double &typedArray);
...
HRESULT Interop_Marshal_UINT8_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    unsigned char *&pParam);
HRESULT Interop_Marshal_UINT16_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    unsigned short int *&pParam);
HRESULT Interop_Marshal_UINT32_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    unsigned int *&pParam);
HRESULT Interop_Marshal_UINT64_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    unsigned __int64 *&pParam);
HRESULT Interop_Marshal_CHAR_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    char *&pParam);
HRESULT Interop_Marshal_INT8_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    signed char *&pParam);
HRESULT Interop_Marshal_INT16_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    signed short int *&pParam);
HRESULT Interop_Marshal_INT32_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    signed int *&pParam);
HRESULT Interop_Marshal_INT64_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    signed __int64 *&pParam);
#if !defined(NANOCLR_EMULATED_FLOATINGPOINT)
HRESULT Interop_Marshal_float_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    float *&pParam);
HRESULT Interop_Marshal_double_ByRef(
    const CLR_RT_StackFrame &stackFrame,
    void *pHeapBlock,
    unsigned int paramIndex,
    double *&pParam);
...
**********************************************************************/
typedef HRESULT (
    *InitializeInterruptsProc)(CLR_RT_HeapBlock_NativeEventDispatcher *pContext, unsigned __int64 userData);
